...
const initialState = {
  trucks: [
    ...
    {
      id: '14',
      name: 'Vagabond Cruiser XL',
      price: 9000,
      rating: 4.4,
      location: 'Ukraine, Lviv',
      description:
        'Explore with ease and style in the Vagabond Cruiser XL, a nimble yet spacious panel truck...',
      form: 'panelTruck',
      length: '6.1m',
      width: '2.0m',
      height: '2.9m',
      tank: '110l',
      consumption: '13.2l/100km',
      transmission: 'automatic',
      engine: 'diesel',
      AC: true,
      bathroom: false,
      ...
      reviews: [
        {
          reviewer_name: 'Alice',
          reviewer_rating: 5,
          comment: 'A fantastic panel truck for weekend getaways!'
        },
        {
          reviewer_name: 'Bob',
          reviewer_rating: 4,
          comment: 'Comfortable, but could use a little more storage space.'
        }
      ]
    },
    {
      ...
      reviews: [
        ...
        },
        {
          reviewer_name: 'Bob',
          reviewer_rating: 4,
          comment: 'Overall, a good vehicle, though the bathroom could be better.'
        }
      ]
    },
    {
      ...
      reviews: [
        {
          reviewer_name: 'Alice',
          reviewer_rating: 5,
          comment: 'Fantastic motorhome! It had everything we needed for our long road trip.'
        },
        {
          reviewer_name: 'Bob',
          reviewer_rating: 3,
    ...
    },
    {
      ...
      location: 'Ukraine, Kharkiv',
      description:
        'The Sunset Voyager is perfect for those who want to enjoy a relaxing journey...',
      form: 'fullyIntegrated',
      length: '7.1m',
      width: '2.5m',
      height: '3.5m',
      tank: '200l',
      consumption: '28l/100km',
      transmission: 'automatic',
      engine: 'diesel',
      AC: true,
      bathroom: true,
      ...
      reviews: [
        {
          reviewer_name: 'Alice',
          reviewer_rating: 5,
          comment: 'Ideal camper for a smooth trip across the countryside.'
        },
        {
          reviewer_name: 'Bob',
          reviewer_rating: 4,
          comment: 'A great option, but could use a better entertainment system.'
        }
      ]
    },
    {
      id: '20',
      name: 'Star Trail Camper',
      price: 9500,
      rating: 4.5,
      location: 'Ukraine, Odesa',
      description:
        'The Star Trail Camper is designed for adventurers who want to explore in comfort...',
      form: 'panelTruck',
      length: '6.2m',
      width: '2.0m',
      height: '2.8m',
      ...
      reviews: [
        {
          reviewer_name: 'Alice',
          reviewer_rating: 5,
          comment: 'Great camper for stargazing trips!'
        },
        {
          reviewer_name: 'Bob',
          reviewer_rating: 3,
          comment: 'Overall good, but felt a bit small for longer trips.'
        }
      ]
    },
    {
      ...
      reviews: [
        {
          reviewer_name: 'Alice',
          reviewer_rating: 5,
          comment: 'Loved the layout of this camper, perfect for a family!'
        },
        {
          reviewer_name: 'Bob',
          reviewer_rating: 4,
          comment: 'Good vehicle, but could use more power outlets.'
        }
      ]
    },
    {
      ...
      rating: 4.4,
      location: 'Ukraine, Kyiv',
      description: 'Take on the wild with the Wild Explorer camper...',
      form: 'fullyIntegrated',
      length: '7.2m',
      width: '2.4m',
      height: '3.6m',
      ...
      reviews: [
        {
          reviewer_name: 'Alice',
          reviewer_rating: 5,
          comment: 'A fantastic choice for longer trips in nature.'
        },
        {
          reviewer_name: 'Bob',
          reviewer_rating: 4,
          comment: 'Great vehicle, but I wish the fuel consumption was a bit better.'
        }
      ]
    },
    {
